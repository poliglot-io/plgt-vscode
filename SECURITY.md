...
Only the latest minor release of the Poliglot VS Code extension receives security updates while the project is in alpha. Older versions should be considered unsupported.

## Reporting a vulnerability

**Please do not file public GitHub issues for security vulnerabilities.** Instead, use GitHub's [private security advisories](https://github.com/poliglot-io/plgt-vscode/security/advisories/new) to report a vulnerability directly to the maintainers.
